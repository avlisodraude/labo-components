...
export class NISVConfig extends CollectionConfig {
	...
	//The differences with the NISVCatalogue are:
	// - there are no .raw subfields defined in the this mapping
	// - the sortdate is not properly mapped, so the date field must be used
	//TODO merge the ES mappings, so both configs can be combined
	getFacets() {
		return [
			{
				field : 'title_raw',
